...
const ScenarioForm: React.FC<ScenarioFormProps> = ({ onSubmit, isLoading = false }) => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-6 mb-8 transform transition-all hover:shadow-lg">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Describe Your Collaboration Scenario</h2>
