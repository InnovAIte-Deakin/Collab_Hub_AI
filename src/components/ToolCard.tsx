    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg mb-6">
      <div className="bg-gradient-to-r from-blue-800 to-blue-700 px-6 py-4">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-semibold text-white">{recommendation.tool}</h3>
          <span className={`px-3 py-1 rounded-full text-xs font-medium ${difficultyColors[recommendation.difficulty]}`}>
      ...
      <div className="p-6">
        <h4 className="text-lg font-medium text-gray-800 mb-3">Prompt Example:</h4>
